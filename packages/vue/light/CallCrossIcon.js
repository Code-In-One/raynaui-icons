...
module.exports = function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
    ...
    _createElementVNode("path", { d: "M17.042 4.879a1 1 0 1 0-1.414 1.414l.707.707-.707.707a1 1 0 1 0 1.414 1.414l.707-.707.707.707a1 1 0 1 0 1.415-1.414L19.163 7l.707-.707a1 1 0 0 0-1.414-1.414l-.707.707z" })
  ]))
}