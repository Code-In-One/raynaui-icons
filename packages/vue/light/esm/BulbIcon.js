...
export default function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
    ...
    _createElementVNode("path", { d: "M13.442 7.29a1 1 0 0 1 .129 1.263 1 1 0 0 1 .446 1.59l-1.257 1.5a1 1 0 0 1-1.628-1.15 1 1 0 0 1-.592-1.697l1.488-1.5a1 1 0 0 1 1.414-.006" }),
