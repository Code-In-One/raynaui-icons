...
export default function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
    ...
    _createElementVNode("path", { d: "M3.146 19.445a1 1 0 1 1-1.792-.89 6.3 6.3 0 0 1 1.623-2.052c.7-.568 1.597-1.003 2.62-1.003a1 1 0 1 1 0 2c-.44 0-.906.188-1.358.555a4.3 4.3 0 0 0-1.093 1.39" }),
    _createElementVNode("path", {
      "fill-rule": "evenodd",
      d: "M16.06 12a3 3 0 1 1 6 0 3 3 0 0 1-6 0m3-1a1 1 0 1 0 0 2 1 1 0 0 0 0-2",
      "clip-rule": "evenodd"
    }),
    _createElementVNode("path", { d: "M23.15 18.555a1 1 0 0 1-1.791.89 4.3 4.3 0 0 0-1.093-1.39c-.452-.367-.918-.555-1.359-.555a1 1 0 0 1 0-2c1.024 0 1.92.435 2.62 1.003a6.3 6.3 0 0 1 1.623 2.052" })
  ]))
}