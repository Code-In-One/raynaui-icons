...
export default function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
    ...
    _createElementVNode("path", { d: "M9.5 22a1.25 1.25 0 1 0 0-2.5 1.25 1.25 0 0 0 0 2.5M19.75 20.75a1.25 1.25 0 1 1-2.5 0 1.25 1.25 0 0 1 2.5 0M22.592 3.707a1 1 0 1 0-1.414-1.414l-1.939 1.939-.282-.282a1 1 0 1 0-1.414 1.414l.989.989a1 1 0 0 0 1.414 0z" })
  ]))
}