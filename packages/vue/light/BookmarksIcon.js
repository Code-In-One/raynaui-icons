...
module.exports = function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
    ...
    _createElementVNode("path", { d: "M5.886 3.818c-.997 0-1.818.817-1.818 1.84V13.8c0 .906 1.129 1.252 1.64.549l.25-.343a2.7 2.7 0 0 1 1.747-1.085v1.903a.9.9 0 0 0-.277.252l-.25.343C5.612 17.572 2.25 16.436 2.25 13.8V5.657C2.25 3.644 3.872 2 5.886 2h4.546c2.008 0 3.625 1.633 3.636 3.637H12.25a1.83 1.83 0 0 0-1.818-1.819z" }),
