...
module.exports = function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
    ...
    _createElementVNode("path", { d: "M14.486 9.326a1 1 0 0 0 .94.94l2.003.118a1 1 0 0 0 .318-1.965l1.98-1.98a1 1 0 0 0-1.414-1.414l-1.98 1.98a1 1 0 0 0-1.965.318z" })
  ]))
}