...
export default function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
    ...
    _createElementVNode("path", { d: "m14.81 17.345-1.416.708a2 2 0 0 1-1.788 0l-1.416-.708a.446.446 0 0 0-.63.284q-.06.225-.06.458v3.315c0 1.112 1.43 1.564 2.069.655a1.138 1.138 0 0 1 1.862 0c.64.909 2.069.457 2.069-.655v-3.315q0-.233-.06-.458a.446.446 0 0 0-.63-.284" })
  ]))
}