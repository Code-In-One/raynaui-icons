...
module.exports = function render(_ctx, _cache) {
  return (_openBlock(), _createElementBlock("svg", {
    ...
    _createElementVNode("path", { d: "M14.237 9.327a1 1 0 0 0 .94.94l2.003.117a1 1 0 0 0 .318-1.964l1.98-1.98a1 1 0 0 0-1.414-1.415l-1.98 1.98a1 1 0 0 0-1.965.318z" })
  ]))
}